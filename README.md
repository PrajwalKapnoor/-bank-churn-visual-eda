# -bank-churn-visual-eda
Visual EDA on Bank Customer Churn | Python · Pandas · Seaborn · Matplotlib

🔍 I analyzed 10,000 bank customers to find out why they leave — and the results were not what I expected.
Built a full Visual EDA project on the Bank Customer Churn dataset using Python, Seaborn & Matplotlib. No ML models — just data storytelling that surfaces real business decisions.
